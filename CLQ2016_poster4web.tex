...
\definecolor{greygher}{RGB}{200, 200, 200}  	% grey 
...
\newcommand{\figheight}{.075\textheight}
...
%\usebackgroundtemplate{\tikz\node[opacity=0.2]{\parbox[c][\paperheight][c]{\paperwidth}{\hspace{-.25cm}\includegraphics[width=1.05\paperwidth]{./background.jpg}}};}
...
%\node[anchor=north west,yshift=-5cm,xshift=.25cm] at (current page.north west) {\tiny Image credit: ESA};
...
\begin{columns}[totalwidth=1.\textwidth,t]
...
\putlogo{coq_wallon}\seplogo\putlogo{logo_IOC}\seplogo\putlogo{logoSocib.png}\seplogo\putlogo{logo_CNES}\seplogo\putlogo{logo_esa}

\vspace{.35cm}

\putlogo{logo_nasa}\seplogo\putlogo{logo_onr}\seplogo\putlogo{logo_iugg}\seplogo\putlogo{logo_eumetsat}%\seplogo\putlogo{logo_SCOR}\seplogo
