...
\scriptsize
%with the support of\\
\putlogolink{http://www.wallonie.be/}{coq_wallon}\seplogo\putlogolink{http://ioc-unesco.org/}{logo_IOC}\seplogo\putlogolink{http://socib.es/}{logoSocib}\seplogo\putlogolink{https://cnes.fr}{logo_CNES}\seplogo\putlogolink{http://www.esa.int/ESA}{logo_esa}

\vspace{.2cm}

\putlogolink{http://www.onr.navy.mil/}{logo_ONR}\seplogo\putlogolink{http://www.nasa.gov/}{logo_nasa}\seplogo\putlogolink{http://www.iugg.org/}{logo_iugg}\seplogo\putlogolink{http://www.eumetsat.int}{logo_eumetsat}\seplogo\putlogolink{http://www.scor-int.org/}{logo_scor.pdf}
...
\column{.18\textwidth}
\putlogolink{http://marine.copernicus.eu/}{logo_CMEMS.jpg}
