...
\node[anchor=south west,inner sep=0] (image) at (0,0) {\pgfimage[interpolate=true,width=.6\textwidth]{main_fig2_resize3}};
...
\scriptsize
%with the support of\\
\putlogolink{http://www.wallonie.be/}{coq_wallon}\seplogo\putlogolink{http://ioc-unesco.org/}{logo_IOC}\seplogo\putlogolink{http://socib.es/}{logoSocib}\seplogo\putlogolink{https://cnes.fr}{logo_CNES}\seplogo\putlogolink{http://www.esa.int/ESA}{logo_esa}\seplogo\putlogolink{http://www.onr.navy.mil/}{logo_ONR}

\vspace{.2cm}

\putlogolink{http://www.nasa.gov/}{logo_nasa}\seplogo\putlogolink{http://www.iugg.org/}{logo_iugg}\seplogo\putlogolink{http://www.eumetsat.int}{logo_eumetsat}\seplogo\putlogolink{http://www.scor-int.org/}{logo_scor.pdf}\seplogo\putlogolink{http://marine.copernicus.eu/}{logo_CMEMS.jpg}\seplogo\putlogolink{http://www.fnrs.be/}{logo_fnrs}
