...
\node[anchor=north west,yshift=-8.7cm,xshift=.3cm] at (current page.north west) {\tiny Image credit: ESA};
...
\coordinate (tp6) at ([yshift=1.4cm]current page.south west);
\coordinate (tp7) at ([yshift=1.4cm]current page.south east);
...
\putlogoB{logo_gher}\seplogo\putlogoB{logo_imedea}\seplogo\putlogoB{logo_whoi} %\seplogo\putlogo{logo_ulg}\\
...
\scriptsize
%with the support of\\
\putlogo{coq_wallon}\seplogo\putlogo{logo_IOC}\seplogo\putlogo{logoSocib}\seplogo\putlogo{logo_CNES}\seplogo\putlogo{logo_esa}\seplogo

\vspace{.04cm}

\putlogo{logo_nasa}\seplogo\putlogo{logo_onr}\seplogo\putlogo{logo_iugg}\seplogo\putlogo{logo_eumetsat}\seplogo\putlogo{logo_scor.pdf}\seplogo
