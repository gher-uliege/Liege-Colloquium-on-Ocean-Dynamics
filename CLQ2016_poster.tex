\documentclass[final,table,14pt,aspectratio=43]{beamer}
...
\definecolor{greygher}{RGB}{150, 150, 150}  	% grey 
...
\node[anchor=north east,yshift=0pt,xshift=-.5cm] at (current page.north east) {\includegraphics[height=.07\textheight]{logo_colloquium}};
...
\Letter~~~\href{mailto:oceanphys@ulg.ac.be}{oceanphys@ulg.ac.be}\\
