...
\setmainfont[Path = /home/ctroupin/.fonts/]{TitilliumMaps29L-800wt.otf}
\setsansfont[Path = /home/ctroupin/.fonts/]{TitilliumMaps29L-800wt.otf}
...
\usebackgroundtemplate{\tikz\node[opacity=0.2]{\parbox[c][\paperheight][c]{\paperwidth}{\hspace{-.25cm}\includegraphics[width=1.05\paperwidth]{../figures/background2.jpg}}};}
...
\node[anchor=south west,yshift=1.7cm,xshift=.3cm] at (current page.south west) {\tiny Image credit: ESA};
\end{tikzpicture}
}
...
\coordinate (tp1) at ([yshift=-.4cm]current page.north west);
\coordinate (tp2) at ([yshift=-1.85cm]current page.north west);
\coordinate (tp3) at ([yshift=-1.85cm]current page.north east);
\coordinate (tp4) at ([yshift=-.4cm]current page.north east);

\coordinate (tp5) at (current page.south west);
\coordinate (tp6) at ([yshift=1.85cm]current page.south west);
\coordinate (tp7) at ([yshift=1.85cm]current page.south east);
\coordinate (tp8) at (current page.south east);
\filldraw[draw=none,fill=white,opacity=0.35] (tp1)--(tp2)--(tp3)--(tp4)--cycle;
\filldraw[draw=greygher,fill=white,opacity=0.7] (tp5)--(tp6)--(tp7)--(tp8)--cycle;
\end{tikzpicture}
...
\node[anchor=south west,inner sep=0] (image) at (0,0) {\pgfimage[interpolate=true,width=.6\textwidth]{../figures/main_fig2_resize3}};
...
\putlogolink{http://modb.oce.ulg.ac.be/}{logo_gher}\seplogo\putlogolink{http://imedea.uib-csic.es/}{logo_imedea}\seplogo\putlogolink{http://www.whoi.edu/	}{logo_whoi} %\seplogo\putlogo{logo_ulg}\\
...
\scriptsize
%with the support of\\
\putlogolink{http://www.wallonie.be/}{coq_wallon}\seplogo\putlogolink{http://ioc-unesco.org/}{logo_ioc.png}\seplogo\putlogolink{http://socib.es/}{logoSocib}\seplogo\putlogolink{https://cnes.fr}{logo_CNES}\seplogo\putlogolink{http://www.esa.int/ESA}{logo_esa}\seplogo\putlogolink{http://www.nasa.gov/}{logo_nasa}

\vspace{.2cm}

\putlogolink{http://www.iugg.org/}{logo_iugg}\seplogo\putlogolink{http://www.eumetsat.int}{logo_eumetsat}\seplogo\putlogolink{http://www.scor-int.org/}{logo_scor.pdf}\seplogo\putlogolink{http://marine.copernicus.eu/}{logo_CMEMS.jpg}\seplogo\putlogolink{http://www.fnrs.be/}{logo_fnrs}
