...
\coordinate (tp2) at ([yshift=-8.5cm]current page.north west);
\coordinate (tp3) at ([yshift=-8.5cm]current page.north east);
...
\node[anchor=north east,yshift=-125pt,xshift=-.5cm] at (current page.north east) {\includegraphics[height=.07\textheight]{logo_colloquium}};
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth]{colloquium_background2}
\end{figure}
%
%
{\footnotesize
