...
\coordinate (tp1) at ([yshift=-.25cm, xshift=.25cm]current page.north west);
\coordinate (tp2) at ([yshift=-8.5cm, xshift=.25cm]current page.north west);
\coordinate (tp3) at ([yshift=-8.5cm, xshift=-.25cm]current page.north east);
\coordinate (tp4) at ([yshift=-.25cm, xshift=-.25cm]current page.north east);
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{colloquium_background2.png}%\includegraphics[width=.5\textwidth]{clq_background2}
...
\column{.6\textwidth}
\scriptsize
\putlogolink{http://www.wallonie.be/}{coq_wallon} \seplogo \putlogolink{http://www.fnrs.be/}{logo_fnrs}\seplogo \putlogolink{https://www.esa.int/ESA}{logo_esa}\seplogo \putlogolink{https://www.belspo.be/}{logo_belspo}
\end{columns}
};
\end{tikzpicture}
